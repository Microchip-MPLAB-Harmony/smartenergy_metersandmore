...
<#elseif HarmonyCore.SELECT_RTOS == "ThreadX">
    (void) tx_byte_allocate(&byte_pool_0,
        (VOID **) &lMM_HI_Task_Stk_Ptr,
        MM_STACK_RTOS_STACK_SIZE,
        TX_NO_WAIT
    );

    (void) tx_thread_create(&lMM_HI_Task_TCB,
        "MM_STACK_TASKS",
        lMM_HI_Tasks,
        0,
        lMM_HI_Task_Stk_Ptr,
...
<#elseif HarmonyCore.SELECT_RTOS == "MicriumOSIII">
    ...
    (void) OSTaskCreate((OS_TCB      *)&lMM_HI_Tasks_TCB,
                 (CPU_CHAR    *)"MM_STACK_TASKS",
                 (OS_TASK_PTR  )lMM_HI_Tasks,
                 (void        *)0,
                 (OS_PRIO      )MM_STACK_RTOS_TASK_PRIORITY,
                 (CPU_STK     *)&lMM_HI_TasksStk[0],
                 (CPU_STK_SIZE )0u,
...
<#elseif HarmonyCore.SELECT_RTOS == "MbedOS">
    Thread MM_STACK_thread((osPriority)(osPriorityNormal + (MM_STACK_RTOS_TASK_PRIORITY - 1)), MM_STACK_RTOS_STACK_SIZE, NULL, "lMM_HI_Tasks");
    (void) MM_STACK_thread.start(callback(lMM_HI_Tasks, (void *)NULL));
</#if>
