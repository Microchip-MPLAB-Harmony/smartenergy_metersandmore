...
{
    .read = (MMHI_PLIB_READ)${.vars["${MMHI_UART_DEVICE?lower_case}"].USART_PLIB_API_PREFIX}_Read,
    ...
    .write = (MMHI_PLIB_WRITE)${.vars["${MMHI_UART_DEVICE?lower_case}"].USART_PLIB_API_PREFIX}_Write,
